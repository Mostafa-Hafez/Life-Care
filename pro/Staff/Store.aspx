<%@ Page Title="" Language="C#" MasterPageFile="~/Pharmacy.Master" AutoEventWireup="true" CodeBehind="Store.aspx.cs" Inherits="pro.Staff.Store" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Number" SortExpression="Med_Num">
            <EditItemTemplate>
        ...
        <asp:TemplateField HeaderText="Description" SortExpression="Med_Des">
            ...
            <ItemTemplate>
                <asp:Label ID="Label7" runat="server" Text='<%# Bind("Med_Des") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
